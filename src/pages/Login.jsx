        ...
        <div className={'login'}>
          ...
          <div className={'a-content'}>
            ...
            <div className={'go-register'}>
              <a href={'http://www.clorishut.com:83/user/setter/changepassword'} className={'forgetPass'}>忘记密码 ? </a>
    ...
    if(this.state.telValue === ""){
      ...
      if(!telReg.test(this.state.telValue )){
        ...
        if(this.state.pwdVal === ""){
          ...
          //fetch请求
          fetch("http://10.36.176.135:5000/user/login/",{
            method:"POST",
            headers:{
            ...
            res.json().then(data=>{
              ...
              if(data.status==0){
                console.log(data)
                // localStorage.setItem("user",this.state.telValue);
                window.location.href="http://www.clorishut.com:83/home"
              }else {
                alert("失败")
              }
